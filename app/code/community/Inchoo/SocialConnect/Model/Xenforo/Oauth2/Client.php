...
class Inchoo_SocialConnect_Model_Xenforo_Oauth2_Client
{   
    const REDIRECT_URI_ROUTE = 'socialconnect/xenforo/connect';

    const XML_PATH_ENABLED = 'customer/inchoo_socialconnect_xenforo/enabled';
    const XML_PATH_CLIENT_ID = 'customer/inchoo_socialconnect_xenforo/client_id';
    const XML_PATH_CLIENT_SECRET = 'customer/inchoo_socialconnect_xenforo/client_secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new Inchoo_SocialConnect_XenforoOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('inchoo_socialconnect')
